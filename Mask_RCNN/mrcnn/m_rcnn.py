...
ROOT_DIR = os.path.abspath("/content/gdrive/MyDrive/Colab Notebooks/Thyroid_Train_Mask_RCNN/Mask_RCNN")
#/content/gdrive/MyDrive/Colab Notebooks/Nombre_Archivo/Mask_RCNN
print("VERS 0.2")
# Import Mask RCNN
